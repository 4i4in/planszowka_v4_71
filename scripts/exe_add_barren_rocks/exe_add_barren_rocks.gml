function exe_add_barren_rocks(_terrain_markers_array)
{
	for(var _ii = 0; _ii < 4; _ii++)
		{
			...
			var _tex_marker_pictr = tex_struct._terrain_cover_barren_rocks;
			var _tex_marker_alpha = tex_struct._terrain_cover_barren_rocks_alpha;
