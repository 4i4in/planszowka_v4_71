function exe_draw_minimap_underground()
{
	//============================
	...
	if !surface_exists(underground_minimap_moved)	{underground_minimap_moved = surface_create(control_array.map_x,control_array.map_y);};
	surface_set_target(underground_minimap_moved);
	draw_clear_alpha(0,0);
	draw_surface_tiled(underground_minimap,_shift_x,_shift_y);
