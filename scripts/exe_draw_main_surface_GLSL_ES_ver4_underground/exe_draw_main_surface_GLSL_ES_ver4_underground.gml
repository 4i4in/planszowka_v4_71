function exe_draw_main_surface_GLSL_ES_ver4_underground(_pipeline)
{
	...
	draw_clear(c_dkgray);
	shader_set(shd_flat_layers_2_glow);
	texture_set_stage(shader_get_sampler_index(shd_flat_layers_2_glow,"base_surface"),surface_get_texture(base_surface));
	texture_set_stage(shader_get_sampler_index(shd_flat_layers_2_glow,"outline_surface"),surface_get_texture(outline_surface));
	texture_set_stage(shader_get_sampler_index(shd_flat_layers_2_glow,"glow_surface"),surface_get_texture(glow_surface2));
	texture_set_stage(shader_get_sampler_index(shd_flat_layers_2_glow,"cover_surface"),surface_get_texture(terrain_cover_surface));
