function exe_draw_minimap_underdark()
{
	//============================
	...
	if !surface_exists(underdark_minimap_moved)	{underdark_minimap_moved = surface_create(control_array.map_x,control_array.map_y);};
	surface_set_target(underdark_minimap_moved);
	draw_clear_alpha(0,0);
	draw_surface_tiled(underdark_minimap,_shift_x,_shift_y);
