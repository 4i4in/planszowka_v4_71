function exe_draw_tiles_underdark_GLSL_ES_ver2(_xx1,_yy1,_tile,_xref,_yref,_render_pass)
{
	switch(_tile.base_name)
		{
			case "magma":
			
				var _color_texture = tex_struct._tile_underdark_magma1;
				...
				break;
			case "obsidian":
				var _color_texture = tex_struct._tile_underdark_obsidian1;
				...
				break;
			case "granite":
				var _color_texture = tex_struct._tile_underdark_granite1;
				...
				break;
			case "olivine":
				var _color_texture = tex_struct._tile_underdark_olivine1;
				//if _tile.climate[0] < control_array.climate[0]	{	_color_texture = tex_struct._tile_ground_lowland1_cold;		};
				//if _tile.climate[0] > control_array.climate[1]	{	_color_texture = tex_struct._tile_ground_lowland1_hot;		};
				...
				break;
			case "organogenic":
				var _color_texture = tex_struct._tile_underdark_organogenic1;
				//if _tile.climate[0] < control_array.climate[0]	{	_color_texture = tex_struct._tile_ground_lowland1_cold;		};
				//if _tile.climate[0] > control_array.climate[1]	{	_color_texture = tex_struct._tile_ground_lowland1_hot;		};
				...
				break;
			case "metamorphic":
				var _color_texture = tex_struct._tile_underdark_metamorphic1;
				//if _tile.climate[0] < control_array.climate[0]	{	_color_texture = tex_struct._tile_ground_lowland1_cold;		};
				//if _tile.climate[0] > control_array.climate[1]	{	_color_texture = tex_struct._tile_ground_lowland1_hot;		};
				...
				break;
			case "chemic":
				var _color_texture = tex_struct._tile_underdark_chemic1;
				//if _tile.climate[0] < control_array.climate[0]	{	_color_texture = tex_struct._tile_ground_lowland1_cold;		};
				//if _tile.climate[0] > control_array.climate[1]	{	_color_texture = tex_struct._tile_ground_lowland1_hot;		};
				...
				break;
			case "none":
				var _color_texture = tex_struct._tile_underdark_none1;
				if _render_pass = 1
					{
						exe_draw_tile_base_GLSL_ES_ver2(_xref,_yref,_tile.zref,_color_texture);
