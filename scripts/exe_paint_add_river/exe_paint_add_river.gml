function exe_paint_add_river(_xx1,_yy1)
{
			...
			else
				{
					...
					if _is_around < 1
					...
					else
						{
							...
							var _tcstruct_rivers0 = _tile.terrain_continuos.rivers;
							...
							if _is_water0 > 0	{	_tcstruct_rivers0 = exe_add_river_delta(_tcstruct_rivers0,_dir,_previous_x,_previous_y,"ground");	}
							else				{	_tcstruct_rivers0 = exe_add_river(_tcstruct_rivers0,_dir,_previous_x,_previous_y,"ground");	};
							
							if _is_water1 > 0	{	_tcstruct_rivers2 = exe_add_river_delta(_tcstruct_rivers2,_new_dir,_xx1,_yy1,"ground");	}
							else				{	_tcstruct_rivers2 = exe_add_river(_tcstruct_rivers2,_new_dir,_xx1,_yy1,"ground");	};
