function exe_add_steppe_item(_terrain_markers_array)
{	
	var _tex_marker_pictr = tex_struct._terrain_item_steppe;
	var _tex_marker_alpha = tex_struct._terrain_item_steppe_alpha;
