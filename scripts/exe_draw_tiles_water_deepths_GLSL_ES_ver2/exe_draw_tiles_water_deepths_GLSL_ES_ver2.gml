function exe_draw_tiles_water_deepths_GLSL_ES_ver2(_xx1,_yy1,_tile,_xref,_yref,_render_pass)
{
	switch(_tile.base_name)
		{
			case "abbysal_plain":
			
				var _color_texture = tex_struct._tile_deepths_abbysal_plain1;
				...
				break;
			case "open_depths":
				var _color_texture = tex_struct._tile_deepths_open_depths1;
				...
				break;
			case "none":
				var _color_texture = tex_struct._tile_deepths_none1;
				if _render_pass = 1
					{
						exe_draw_tile_base_GLSL_ES_ver2(_xref,_yref,_tile.zref,_color_texture);
