function exe_add_swmap(_terrain_markers_array)
{
	var _tex_marker_pictr = tex_struct._terrain_cover_swmap;
	var _tex_marker_alpha = tex_struct._terrain_cover_swmap_alpha;
