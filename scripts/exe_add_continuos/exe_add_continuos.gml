function exe_add_continuos(_tcstruct_rivers,_dir,_xto,_yto,_mapto,_road_type,_construction_progress)
{
	...
	if _same_dir_found < 1
		{
			switch(_road_type)
				{
					case "path" :
						var _tex_marker_pictr = tex_struct._terrain_continuos_path;
						var _tex_marker_alpha = tex_struct._terrain_continuos_path_alpha;
						break;
					case "road" :
						var _tex_marker_pictr = tex_struct._terrain_continuos_road;
						var _tex_marker_alpha = tex_struct._terrain_continuos_road_alpha;
						break;
					case "dwarfroad" :
						var _tex_marker_pictr = tex_struct._terrain_continuos_dwarfroad;
						var _tex_marker_alpha = tex_struct._terrain_continuos_dwarfroad_alpha;
						break;
				};			
