function exe_draw_minimap_underwater()
{
	//============================
	...
	if !surface_exists(underwater_minimap_moved)	{underwater_minimap_moved = surface_create(control_array.map_x,control_array.map_y);};
	surface_set_target(underwater_minimap_moved);
	draw_clear_alpha(0,0);
	draw_surface_tiled(underwater_minimap,_shift_x,_shift_y);
