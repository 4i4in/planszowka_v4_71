function exe_paint_change_humidity_ground(_xx1,_yy1,_change)
{
	var _value = game_map[$ control_array.map_current_name_level][_xx1][_yy1][$ "climate"][1];
	_value += _change;
	if _value < 0.	{_value = 0.;};
	if _value > 1.	{_value = 1.;};
	game_map[$ control_array.map_current_name_level][_xx1][_yy1][$ "climate"][1] = _value;
