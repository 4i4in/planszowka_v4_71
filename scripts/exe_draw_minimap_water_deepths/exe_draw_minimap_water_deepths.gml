function exe_draw_minimap_water_deepths()
{
	//============================
	...
	if !surface_exists(water_deepths_minimap_moved)	{water_deepths_minimap_moved = surface_create(control_array.map_x,control_array.map_y);};
	surface_set_target(water_deepths_minimap_moved);
	draw_clear_alpha(0,0);
	draw_surface_tiled(water_deepths_minimap,_shift_x,_shift_y);
