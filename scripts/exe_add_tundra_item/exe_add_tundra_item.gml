function exe_add_tundra_item(_terrain_markers_array)
{	
	var _tex_marker_pictr = tex_struct._terrain_item_tundra;
	var _tex_marker_alpha = tex_struct._terrain_item_tundra_alpha;
