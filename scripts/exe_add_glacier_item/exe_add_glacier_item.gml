function exe_add_glacier_item(_terrain_markers_array)
{	
	var _tex_marker_pictr = tex_struct._terrain_item_glacier;
	var _tex_marker_alpha = tex_struct._terrain_item_glacier_alpha;
