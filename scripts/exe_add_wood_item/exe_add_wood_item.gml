function exe_add_wood_item(_terrain_markers_array)
{	
	var _tex_marker_pictr = tex_struct._terrain_item_wood;
	var _tex_marker_alpha = tex_struct._terrain_item_wood_alpha;
