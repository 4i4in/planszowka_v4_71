function exe_add_river_delta(_tcstruct_rivers,_dir,_xto,_yto,_mapto)
{
	var _tex_marker_pictr = tex_struct._terrain_continuos_river_delta;
	var _tex_marker_alpha = tex_struct._terrain_continuos_river_delta_alpha;
