function exe_add_frozen_sea_plain(_terrain_markers_array)
{
	var _tex_marker_pictr = tex_struct._terrain_cover_frozen_sea_plain;
	var _tex_marker_alpha = tex_struct._terrain_cover_frozen_sea_plain_alpha;
