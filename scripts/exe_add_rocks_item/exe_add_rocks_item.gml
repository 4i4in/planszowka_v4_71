function exe_add_rocks_item(_terrain_markers_array)
{	
	var _tex_marker_pictr = tex_struct._terrain_item_rocks;
	var _tex_marker_alpha = tex_struct._terrain_item_rocks_alpha;
