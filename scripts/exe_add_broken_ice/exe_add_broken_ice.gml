function exe_add_broken_ice(_terrain_markers_array)
{
	var _tex_marker_pictr = tex_struct._terrain_cover_broken_ice;
	var _tex_marker_alpha = tex_struct._terrain_cover_broken_ice_alpha;
