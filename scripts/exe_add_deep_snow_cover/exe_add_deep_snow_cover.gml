function exe_add_deep_snow_cover(_terrain_markers_array)
{
	var _tex_marker_pictr = tex_struct._terrain_cover_deep_snow_cover;
	var _tex_marker_alpha = tex_struct._terrain_cover_deep_snow_cover_alpha;
