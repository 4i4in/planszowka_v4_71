function exe_add_swmap_item(_terrain_markers_array)
{	
	var _tex_marker_pictr = tex_struct._terrain_item_swmap;
	var _tex_marker_alpha = tex_struct._terrain_item_swmap_alpha;
