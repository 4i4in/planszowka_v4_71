function exe_add_fertile(_terrain_markers_array)
{
	var _tex_marker_pictr = tex_struct._terrain_cover_fertile;
	var _tex_marker_alpha = tex_struct._terrain_cover_fertile_alpha;
