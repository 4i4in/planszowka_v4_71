function exe_add_grass_item(_terrain_markers_array)
{	
	var _tex_marker_pictr = tex_struct._terrain_item_grass;
	var _tex_marker_alpha = tex_struct._terrain_item_grass_alpha;
