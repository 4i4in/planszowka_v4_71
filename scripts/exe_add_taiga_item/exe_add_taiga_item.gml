function exe_add_taiga_item(_terrain_markers_array)
{	
	var _tex_marker_pictr = tex_struct._terrain_item_taiga;
	var _tex_marker_alpha = tex_struct._terrain_item_taiga_alpha;
