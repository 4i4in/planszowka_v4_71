function exe_add_forest_item(_terrain_markers_array)
{	
	var _tex_marker_pictr = tex_struct._terrain_item_forest;
	var _tex_marker_alpha = tex_struct._terrain_item_forest_alpha;
