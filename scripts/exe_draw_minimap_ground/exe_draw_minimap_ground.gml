function exe_draw_minimap_ground()
{
	//============================
	...
	if !surface_exists(ground_minimap_moved)	{ground_minimap_moved = surface_create(control_array.map_x,control_array.map_y);};
	surface_set_target(ground_minimap_moved);
	draw_clear_alpha(0,0);
	draw_surface_tiled(ground_minimap,_shift_x,_shift_y);
