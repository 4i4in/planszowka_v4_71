function exe_draw_minimap_fairyland()
{
	//============================
	...
	if !surface_exists(fairyland_minimap_moved)	{fairyland_minimap_moved = surface_create(control_array.map_x,control_array.map_y);};
	surface_set_target(fairyland_minimap_moved);
	draw_clear_alpha(0,0);
	draw_surface_tiled(fairyland_minimap,_shift_x,_shift_y);
